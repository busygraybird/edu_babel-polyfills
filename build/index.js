...
const nativeBigInt = typeof __webpack_require__.g !== 'undefined' && __webpack_require__.g.BigInt || typeof window !== 'undefined' && window.BigInt;
const supportsNative = typeof nativeBigInt === 'function';

const _BigInt = __webpack_require__(/*! big-integer */ "./node_modules/big-integer/BigInteger.js");

const nativeFunction = function (operator, a) {
  switch (operator) {
    // Arithmetic operators
    case 'add':
      return b => new BigInt(a + b);
...
/* harmony import */ var bigint_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bigint-polyfill */ "./node_modules/bigint-polyfill/index.js");


var getTimedResolvingPromise = function getTimedResolvingPromise(resolveValue, time) {
...
var getTimedRejectingPromise = function getTimedRejectingPromise(resolveValue, time) {
  return new Promise(function (_, reject) {
    return setTimeout(function () {
      return reject(resolveValue);
    }, time);
  });
};

Promise.race([getTimedRejectingPromise(1, 2e3), getTimedResolvingPromise(new bigint_polyfill__WEBPACK_IMPORTED_MODULE_0__(2n), 1e3)]).then(alert);
}();
